...
const OPENROUTER_MODELS: ModelEntry[] = [
  ...
  { id: "tencent/hy3-preview", label: "Tencent Hy3 Preview", provider: "openrouter", desc: "腾讯混元3 MoE大模型（默认低思考）", badge: "thinking-visible" },
  { id: "tencent/hy3-preview-low", label: "Tencent Hy3 Low", provider: "openrouter", desc: "腾讯混元3 MoE大模型（低思考）", badge: "thinking-visible" },
  { id: "tencent/hy3-preview-medium", label: "Tencent Hy3 Medium", provider: "openrouter", desc: "腾讯混元3 MoE大模型（中思考）", badge: "thinking-visible" },
  { id: "tencent/hy3-preview-high", label: "Tencent Hy3 High", provider: "openrouter", desc: "腾讯混元3 MoE大模型（高思考）", badge: "thinking-visible" },
  { id: "tencent/hy3-preview-nothinking", label: "Tencent Hy3 No Thinking", provider: "openrouter", desc: "腾讯混元3 MoE大模型（不思考）", badge: "tools" },
  ...
  { id: "qwen/qwen3.7-plus", label: "Qwen 3.7 Plus", provider: "openrouter", desc: "Alibaba Qwen 3.7 增强版" },
  { id: "qwen/qwen3.6-plus", label: "Qwen 3.6 Plus", provider: "openrouter", desc: "Alibaba Qwen 3.6 增强版" },
  { id: "minimax/minimax-m3", label: "Minimax M3", provider: "openrouter", desc: "MiniMax-Text-01 旗舰模型" },
  { id: "minimax/minimax-m2.7", label: "Minimax M2.7", provider: "openrouter", desc: "MiniMax 性能/性价比模型" },
